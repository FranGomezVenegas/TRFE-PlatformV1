...
requirements="@trazit/platform-login @trazit/relogin-dialog  @trazit/my-incidents @trazit/user-profile @trazit/video-tutorial @trazit/my-certifications @trazit/platform-notif @trazit/tr-procedures @trazit/endpoints-list @trazit/holiday-calendars @trazit/proc-management-home @trazit/platform-usersessions"
yalcDir=`yalc dir`
